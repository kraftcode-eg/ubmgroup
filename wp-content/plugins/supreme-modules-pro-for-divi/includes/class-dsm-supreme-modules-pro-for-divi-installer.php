	...
	public function display_notice() {
		...
		echo sprintf(
			...
			'<p>' . sprintf(
				...
				wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=' . esc_attr( $dsm_supreme_modules_lite_plugin_slug ) ), 'install-plugin_' . esc_attr( $dsm_supreme_modules_lite_plugin_slug ) )
			) . '</p>'
		);
	}
}
